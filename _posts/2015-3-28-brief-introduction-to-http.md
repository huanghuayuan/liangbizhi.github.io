...
![http://liangbizhi.github.io/](/images/brief-introduction-to-http/surf.jpg "浏览器地址栏")
...
![服务器启动](/images/brief-introduction-to-http/server-start.jpg "服务器启动")
...
![浏览器等待响应](/images/brief-introduction-to-http/loading.jpg "浏览器等待响应")

![服务器接收请求](/images/brief-introduction-to-http/request.jpg "服务器接收请求")
...
![服务器发送响应](/images/brief-introduction-to-http/response.jpg "服务器发送响应")

看，我们的浏览器的确接收了响应了，F12看看，一切正常。

![浏览器接收响应](/images/brief-introduction-to-http/browser-response.jpg "浏览器接收响应")
